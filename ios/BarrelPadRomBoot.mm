...
int BarrelPad_PrepareIosRomBoot(void) {
     ...
     * landscape surface. Leave presentation settings to the normal video
     * configuration: the defaults and presets keep the native Hor+ projection
     * enabled, while the player can change the preset or aspect in Settings. */
